...
const Hero = () => {
  ...
  const handleWhatsApp = () => {
    window.open('https://wa.me/+91XXXXXXXXXX', '_blank'); // Replace with your number
  };

  // Add Call handler
  const handleCall = () => {
    window.location.href = 'tel:+91XXXXXXXXXX'; // Replace with your number
  };
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center mb-12 lg:mb-0 lg:flex-row gap-10 mt-10">
          ...
          <button
            ...
            className="shadow shadow-zinc-300 hover:shadow-green-600 hover:shadow px-4 py-2 rounded-3xl flex items-center gap-2"
          >
